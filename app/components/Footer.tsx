...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-8 sm:py-12 mt-24">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About Us</h3>
            <p className="text-sm text-gray-400">Your trusted source for Amazon product recommendations and reviews. Email us</p>
            <p className="mb-4">
        Email:{" "}
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Amazon Affiliate Store. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
